 ...
 */
public class CancionesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    private Context mContext;
    private ArrayList<Cancion> listCanciones;

    public CancionesAdapter(ArrayList<Cancion> listCanciones, Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RecyclerView.ViewHolder viewHolder = new CancionesAdapter.ViewHolder(inflater.inflate(R.layout.item_evento_grid,parent,false));
        return viewHolder;
    }
